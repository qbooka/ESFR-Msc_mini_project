...
# # Custom color map for OpenMC plots
# colordef = {
#     inner_fuel: 'darkmagenta', 
#     outer_fuel: 'cyan', 
#     sodium: 'darkorange', 
#     clad_mat: 'grey', 
#     EM10: 'forestgreen',
...
# # Helper function with clean visuals and titles
# def save_plot(universe, filename, origin, basis, width, pixels, color_by, colors):
#     ax = universe.plot(
#         origin=origin,
#         basis=basis,
#         width=width,
...
#     # Generate descriptive titles from filename
#     view = basis.upper()
#     if 'iFA' in filename:
#         title = f"Inner Fuel Assembly ({view} View)"
#     elif 'oFA' in filename:
#         title = f"Outer Fuel Assembly ({view} View)"
#     elif 'radref' in filename:
#         title = f"Radial Reflector Assembly ({view} View)"
#     elif 'CSDinner' in filename:
#         title = f"Control and Safety Device - Inner Assembly ({view} View)"
#     elif 'CSDouter' in filename:
#         title = f"Control and Safety Device - Outer Assembly ({view} View)"
#     elif 'DSD' in filename:
#         title = f"Driver Safety Device Assembly ({view} View)"
#     elif 'core' in filename:
#         title = f"Complete Reactor Core ({view} View)"
#     else:
#         title = f"{filename.replace('.png', '').replace('_', ' ').title()} ({view} View)"

#     # Add title and labels
#     ax.set_title(title, fontsize=18, pad=10)
#     ax.set_xlabel(f'{basis[0]} [cm]', fontsize=14)
#     ax.set_ylabel(f'{basis[1]} [cm]', fontsize=14)
...
# # === Run clean plots ===
# save_plot(iFA_uni, 'iFA_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)
# save_plot(oFA_uni, 'oFA_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)
# save_plot(radref_ass_uni, 'radref_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)

# save_plot(CSDinner_ass_uni, 'CSDinner_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)
# save_plot(CSDinner_ass_uni, 'CSDinner_xz.png', origin=(0,0,0), basis='xz', width=(25.,100.), pixels=(2000,2000), color_by='material', colors=colordef)

# save_plot(CSDouter_ass_uni, 'CSDouter_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)
# save_plot(CSDouter_ass_uni, 'CSDouter_xz.png', origin=(0,0,0), basis='xz', width=(25.,100.), pixels=(2000,2000), color_by='material', colors=colordef)

# save_plot(DSD_ass_uni, 'DSD_xy.png', origin=(0,0,0), basis='xy', width=(25.,25.), pixels=(2000,2000), color_by='material', colors=colordef)
# save_plot(DSD_ass_uni, 'DSD_xz.png', origin=(0,0,0), basis='xz', width=(25.,100.), pixels=(2000,2000), color_by='material', colors=colordef)

# save_plot(core_uni, 'core_xy.png', origin=(0,0,0), basis='xy', width=(800.,800.), pixels=(4000,4000), color_by='material', colors=colordef)
# save_plot(core_uni, 'core_xz.png', origin=(0,0,0), basis='xz', width=(800.,230.), pixels=(4000,4000), color_by='material', colors=colordef)

# print("✅ All plots saved with clean titles and no legends.")
